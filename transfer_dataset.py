...
# 输入输出路径
dataset_root = "/root/tiny-Kinetics-400/val_256"
output_root = "/root/tiny-Kinetics-400/output_dataset"
videos_dir = os.path.join(output_root, "videos")
os.makedirs(videos_dir, exist_ok=True)

train_csv = os.path.join(output_root, "test.csv")
label_map_txt = os.path.join(output_root, "label_map_test.txt")
